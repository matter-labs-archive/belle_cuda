...
GENERAL_TEST_1_ARGS_1_TYPE(FIELD_MUL_INV, uint256_g)
...
GENERAL_TEST_2_ARGS_3_TYPES(ECC_wNAF_exp_PROJ, ec_point, uint256_g, ec_point);
GENERAL_TEST_2_ARGS_3_TYPES(ECC_wNAF_exp_JAC, ec_point, uint256_g, ec_point);


GENERAL_TEST_2_ARGS_3_TYPES(ECC_double_and_add_affine_exp_PROJ, affine_point, uint256_g, ec_point);
GENERAL_TEST_2_ARGS_3_TYPES(ECC_double_and_add_affine_exp_JAC, affine_point, uint256_g, ec_point);